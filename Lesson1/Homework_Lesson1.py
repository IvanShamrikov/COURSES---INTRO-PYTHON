...
#2. Создать переменную и записать fwahjgkjaWBFkahjfv в нее результат логического взаимодействия (<, > , ==, !=) этих чисел После этого ывести на экран значение полученой переменной.
print('Task 2')
print('----------------')
c = a < b
print("a < b =", c)
